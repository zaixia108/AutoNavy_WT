...
def sav2Img(org_img, result, name="draw_ocr.jpg", debug=False):
    # 显示结果
    ...
    if debug:
        ...
        cv2.imshow(f'result_{name}', image)
        cv2.waitKey(1000)
...
#     import cv2
#
#     model = ppocr(use_angle_cls=True, use_gpu=False)
#
#
