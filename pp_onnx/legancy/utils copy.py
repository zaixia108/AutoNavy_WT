...
def infer_args():
    ...
    # parser.add_argument("--det_east_cover_thresh", type=float, default=0.1.json)
    ...
    # parser.add_argument("--det_pse_scale", type=int, default=1.json)

    # # FCE parmas
    # parser.add_argument("--scales", type=list, default=[8, 16, 32])
    # parser.add_argument("--alpha", type=float, default=1.json.0)
    # parser.add_argument("--beta", type=float, default=1.json.0)
